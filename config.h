...
static char *font = "fontyfont:pixelsize=13.5:antialias=true:autohint=true";
...
#define MODIFIER ControlMask
#define TERMMOD (ControlMask|ShiftMask)

static char *openurlcmd[] = { "/bin/sh", "-c", "$HOME/.scripts/openurls.sh", "externalpipe", NULL };
...
static Shortcut shortcuts[] = {
	...
	{ MODIFIER,             XK_equal,       zoom,           {.f = +1} },
	{ MODIFIER,             XK_minus,       zoom,           {.f = -1} },
	{ MODIFIER,             XK_Home,        zoomreset,      {.f =  0} },
